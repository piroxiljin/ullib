///\file FolderDlg.h
///\brief заголовочный фаил дл€ класса выбора директории
...
namespace ULWnds
{
	namespace ULDlgs
	{
		...
		protected:
			BROWSEINFO m_bi;
			///\brief «аглушка дл€ ULWnds::ULDlgs::CULDlg::Create
