///\file ULSubClass.cpp
///\brief cpp файл класса дл€ сабклассировани€ контролов(07.10.2007)
		...
		case WM_COMPAREITEM:
			{
				...
				{	
					...
					if(fRet==FALSE)
						...
						//дл€ совместимости при обработке WM_COMPAREITEM -1,0,1 должны заменитьс€
		...
		case WM_CHARTOITEM:
			{
				...
				{	
					...
					if(fRet==FALSE)
						...
						//performed in response to the message. A return value of Ц1 or Ц2 
						...
						//дл€ совместимости при обработке WM_VKEYTOITEM -2,-1,0 должны заменитьс€
		...
		case WM_VKEYTOITEM:
			{
				...
				{	
					...
					if(fRet==FALSE)
						...
						//to the message. A return value of Ц2 indicates that the application
						//handled all aspects of selecting the item and requires no further 
						//action by the list box. A return value of Ц1 indicates that the 
